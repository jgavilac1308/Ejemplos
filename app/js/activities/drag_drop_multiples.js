...
lizDragDropMultiples.factory('dragDropMultiplesActivity', function ($rootScope,$sce) {
  ...
  dragDropMultiplesActivity._ViewModel = function (options) {
    ...
    var chances = options.chances,
      ...
      self.groupsPerRow = options.groupsPerRow ? options.groupsPerRow : false;
    ...
    self.getGroupWidth = ko.computed(function () {
      if(self.groupsPerRow){
        return "width: " + (100 / self.groupsPerRow) + "%";
      }else{
